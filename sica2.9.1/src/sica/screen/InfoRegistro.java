...
public class InfoRegistro  extends Screen implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // codigo que se cambio para hacer que los mensajes dure mas el tiempo que se muestra la informacion del checado
            ...
            @Override protected Task<Void> createTask() {
                return new Task<Void>(){
                    @Override protected Void call() {  
                        updateProgress(0, 1);
                        int time = Configs.DATATIME.get()*2000;  
    ...
    public void load(){        
        ...
        if ( data.getTipoRegistroMat() == null ) {
           // System.out.println("TipoRegistroMat resulto = null, se mostrara info para solo entrada");
            ...
            switch (data.getTipoReg()){
                ...
                case MATERIAFUERATOLERANCIA: //NUEVA TOLERANCIA
                ...
                case SINACTIVIDAD:                      //NUEVA TOLERANCIA
                    infoReg.setText("Registro realizado con errores");                
                    info.setText(                        
                            ...
                            + "tolerancia de 10 minutos antes y despues de la "
                       ...
                       /*
                        ...
                        case EYS_MATERIA_SINACTIVIDAD: //en el caso que no haya ninguna actividad
                            ...
                            data.getTipoJornada().equals("sinjornada")?// De asignatura?
                                "No se tiene actividad programada, se ha creado "
                            + "un incidente en el sistema. Recuerde que tiene una "
                            + "tolerancia de 10 minutos antes y despues de la "     //NUEVA TOLERANCIA
        ...
        if ( data.getMensaje()!= null ){
            ...
            //***************************************************************************************************
            /************** codigo editado Cesar ***************/
            // tiempo de mensaje se extendio a 12 segundos si es que existe un mensaje si no sigue igual con 6 segundos
          progressService = new Service<Void>() {
            @Override protected Task<Void> createTask() {
                return new Task<Void>(){
                    @Override protected Void call() {  
        ...
        //************* finaliza codigo editado por Cesar ************************/////////
       //*************************************************************************************** 
