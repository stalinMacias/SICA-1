...
public class AsignaturasController implements Initializable {
                        ...
                        if (item!=null && !empty){
                            ...
                            for (FaltaClase f: item){
                                if ((f.getJustifcante()==null)||
                                    ...
                                    Text t = new Text(f.getCrn().getCrn()+ "," + f.getRegistro().getFechahoraS()+
                                            ", "+f.getCrn().getMateria()                                        
    ...
    private void inicializarVistaTablas(){
        ...
        tolerancias.setCellValueFactory(new PropertyValueFactory <> ("tolerancias"));
        ...
        detalle.prefWidthProperty().bind(tabla.widthProperty().multiply(14/20f).subtract(5));
        checados.prefWidthProperty().bind(tabla.widthProperty().multiply(4/20f).subtract(4));        
