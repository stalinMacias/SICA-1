...
public class DBQueries {    
    ...
    public static boolean addCorreoUsuario(String user, String correo){
        log("Añade correo: "+correo+", al usuario "+user);
    ...
    public static ObservableList<HorarioCrn> get_checking_regfull(String inicio, String fin,String departamento){
        return dbGetter.getList(
                "CALL get_chec_dep1('"+inicio+"', '"+fin+"', '"+departamento+"')",
                HorarioCrn.class);
