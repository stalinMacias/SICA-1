...
public class Autenticator {
    ...
    public static boolean siiauLogin(String usuario, String password) {
        ...
        try {
            ...
            //Si el logueo en el SIIAU se realizo correctamente, llamar al metodo autenticate para inicializar la variable currentUser
            //Dicha variable es utilizada para insertar en la tabla log todos los cambios que se han realizado al sistema!
            autenticate(usuario, password);
