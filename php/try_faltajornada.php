		...
		echo $row["correo"];	
			...
			if (filter_var($row["correo"], FILTER_VALIDATE_EMAIL)) {
				...
				if ( is_null($row["registroentrada"]) && is_null($row["registrosalida"])){
					$asunto = "CUVALLES SICA - Falta jornada laboral";
					...
					$asunto = "CUVALLES SICA - Ausencia de Registro";
				...
				$mensaje = "<div align='justified'>".$mensaje."<p align='justify' style='color:grey;'>Este es un correo autom&aacute;tico generado por el Sistema de Control de Asistencia (SICA) del Centro Universitario de los Valles de la Universidad de Guadalajara. No es necesario que responda a este correo.</p><p>Sistema de Control de Asistencia, CUVALLES.</p></div>";  
				//Favor de atender esta notificaci&oacute;n conforme se indica. se elimino por indicacione de Marco Tulio                                                                                           	
