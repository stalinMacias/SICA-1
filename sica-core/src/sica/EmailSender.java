    ...
    private EmailSender(TipoRegistro tipoReg, UserData usr){        
        ...
        switch (tipoRegistro){
            ...
            case SALIDAANTES:
                ...
                break;
      //------------------------------------------------------
            /* Modificacion de cesar */
            case MATERIA_SIN_REGISTRO:
                opcion = "materia_sin_registro";
                break;
      //------------------------------------------------------          
            case SINACTIVIDAD:
    ...
    public void run() {
       ...
       log.info("la opcion es",opcion);
        ...
        try {                       
            ...
            StringBuilder append = postData.append("opcion=").append(URLEncoder.encode(opcion, "UTF-8"));
