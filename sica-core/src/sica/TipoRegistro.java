...
public enum TipoRegistro {
    ...
    /*Modificacion cesar */
   EYS_MATERIA_SINREGISTRO, // tipo de registro utlizado para cuando no haya registro de entrada ni salida
    SINACTIVIDAD, 
    OFFLINE,
   ...
   // EYS_MATERIA_E_FUERATOLERANCIA,
    ...
    /* sin registros a materia*/
    
    MATERIA_SIN_REGISTRO,
    /* By Cesar Eduardo Chipol Velasco*/
